  ...
  return (
    <>
      <main className="px-5 py-5">
        <section>
          <h1 className="text-[#090429] text-3xl font-bold text-center">
            IELTS: FREE WEBINAR
          </h1>
          <p className="text-justify pt-4 text-xl leading-loose">
            Take advantage of Lucid English' free IELTS webinar which will
          ...
          <ul className="text-justify pt-4 text-xl leading-loose">
            <li>Topics</li>
            <li>1. Test Styles and Takers' Strategies</li>
            <li>2. Completing Reading Test in Time</li>
            <li>3. Paragraphing and Elegant Writing Tips</li>
            <li>4. Smart Listening Techniques</li>
            <li>5. Coherent and Cohesive Speaking Tips</li>
          </ul>
          <p className="text-justify pt-4 text-xl leading-loose">
            Also: Giveaways- sample test questions and free study packs
          </p>
          <p className="text-justify pt-4 text-xl leading-loose">
          ...
          <h2 className="text-justify pt-4 text-xl leading-loose font-bold">
